...
public record PairRoomReadResponse(
        @Schema(description = "페어룸 id", example = "1") long id,
        @Schema(description = "첫 번째 페어의 이름", example = "해시") String firstPair,
        @Schema(description = "두 번째 페어의 이름", example = "파슬리") String secondPair,
        @Schema(description = "타이머 시간. millisecond 기준으로 저장한다.", example = "60000") long timerDuration
) {
