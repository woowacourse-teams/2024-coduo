...
class PairRoomHistoryTest {
    ...
    void create_timer() {
        ...
        // when & then
        assertThatCode(() -> new PairRoomHistory(pairRoom, timerDuration, timerRemainingTime))
    ...
    void throw_exception_when_time_is_negative() {
        ...
        // when, then
        assertThatThrownBy(() -> new PairRoomHistory(pairRoom, timerDuration, timerRemainingTime))
