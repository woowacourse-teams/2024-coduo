...
class OpenGraphServiceTest extends CascadeCleaner {
    ...
    void create_open_graph_exactly() throws IOException {
        ...
        final ReferenceLinkEntity referenceLink = generateReferenceLinkEntity(url);
        ...
        assertAll(
                ...
                () -> assertThat(openGraph)
                        .extracting("headTitle", "openGraphTitle", "description", "image")
                        .contains("헤드 타이틀", "오픈그래프 타이틀", "오픈그래프 설명", "오픈그래프 이미지")
        );
    }
    ...
    void return_null_when_cannot_find_open_graph() {
        ...
        assertThat(openGraph)
                .extracting("headTitle", "openGraphTitle", "description", "image")
                .contains(DEFAULT_OPEN_GRAPH_VALUE, DEFAULT_OPEN_GRAPH_VALUE, DEFAULT_OPEN_GRAPH_VALUE,
                        DEFAULT_OPEN_GRAPH_VALUE);
    }
    ...
    void create_openGraph_when_cannot_get_document() throws IOException {
        ...
        assertAll(
                ...
                () -> assertThat(openGraph)
                        .extracting("headTitle", "openGraphTitle", "description", "image")
                        .contains("localhost", DEFAULT_OPEN_GRAPH_VALUE, DEFAULT_OPEN_GRAPH_VALUE,
                                DEFAULT_OPEN_GRAPH_VALUE)
        );
    }
    ...
    void create_openGraph_when_titles_are_empty() throws IOException {
        ...
        assertAll(
                ...
                () -> assertThat(openGraph)
                        .extracting("headTitle", "openGraphTitle", "description", "image")
                        .contains("localhost", DEFAULT_OPEN_GRAPH_VALUE, "오픈그래프 설명",
                                "오픈그래프 이미지")
        );
    }

    private ReferenceLinkEntity generateReferenceLinkEntity(final URL url) {
        return new ReferenceLinkEntity(
