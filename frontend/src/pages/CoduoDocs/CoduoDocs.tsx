...
작성된 코드를 실시간으로 검토하고 개선할 부분을 제안하며, 코드의 전반적인 구조와 논리를 생각합니다.`}
            ...
            <S.Sentence>
              ...
              <S.Content>
                ...
                <br />
                <strong>역할 정기적으로 교대하기와 코드 자주 커밋하기</strong>
                <p>
                ...
                <br />
                <strong>적절한 페어 구성과 익숙한 개발 환경 사용하기</strong>
                <p>
                ...
                <br />
                <strong>필요할 때 명확히 설명 요청하기와 적절한 휴식 취하기</strong>
                <p>
          ...
          <S.Content>
            <S.Sentence>
              <S.Content>
                ...
                <strong>레퍼런스</strong>
                <p>
                  페어프로그래밍 도중 참고한 레퍼런스 링크를 저장할 수 있습니다. 저장된 레퍼런스는 카테고리별로 정리되어
