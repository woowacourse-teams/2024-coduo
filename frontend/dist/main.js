...
`,({references:e})=>!e||e.length<1?(0,r.jsx)(ke,{children:"저장된 링크가 없습니다."}):(0,r.jsx)(Ee,{$columns:e.length,children:(0,r.jsx)(Re,{$columns:e.length,children:e.map((e=>(0,r.jsx)(ze,{children:(0,r.jsxs)(c.N_,{to:e.url,target:"_blank",children:[e.image?(0,r.jsx)(Oe,{alt:"link",src:e.image}):(0,r.jsxs)(Te,{children:["이미지가",(0,r.jsx)("br",{}),"없습니다"]}),(0,r.jsxs)(Ce,{children:[(0,r.jsx)(_e,{children:e.openGraphTitle||e.headTitle}),(0,r.jsx)(Ie,{children:e.description})]})]})},e.id)))})}));var Me=i(5617),Fe=i(2298),Pe=i(5340),De=i(9270),Ue=i(5778);var Ge=i(8198);const We=h.Ay.div`
  width: 50%;
  min-width: 45rem;
`,He=h.Ay.div`
  display: flex;
...
`,Le=({accessCode:e})=>{const[t,i]=(0,o.useState)(Pe.zb),{isModalOpen:n,openModal:s,closeModal:a}=(0,Fe.A)(),{categories:l,isCategoryExist:c}=(0,Pe.Ay)(e),{references:d}=((e,t)=>{const{data:i}=(0,De.I)({queryKey:[Ue.e.GET_REFERENCE_LINKS,e],queryFn:()=>(async({accessCode:e,categoryId:t})=>{const i="0"===t?"":`?categoryId=${t}`,r=await g.A.get({url:`undefined/${e}/reference-link${i}`,errorMessage:x.U.GET_REFERENCE_LINKS});return await r.json()})({accessCode:t,categoryId:e})});return{references:i}})(t,e),m=(0,Ge.r)(l,t)||Pe.Jf;return(0,r.jsxs)(We,{children:[(0,r.jsxs)(Me.q,{children:[(0,r.jsx)(Ae,{selectedCategoryName:m,onButtonClick:s}),(0,r.jsx)(He,{children:(0,r.jsx)(Ne,{references:d})})]}),(0,r.jsx)(ye,{isOpen:n,closeModal:a,categories:l,isCategoryExist:c,selectedCategoryId:t,handleSelectedCategoryId:e=>i(e)})]})},Be=h.Ay.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 1rem;
`,qe=h.Ay.div`
  color: ${({theme:e})=>e.color.black[700]};
  font-size: ${({theme:e})=>e.fontSize.sm};
`,Ye=({accessCode:e})=>{const t=(0,u.Zp)(),{userStatus:i}=(0,f.A)(),{isUserInPairRoom:o,isUserInPairRoomFetching:n}=(e=>{const{data:t,isFetching:i}=(0,De.I)({queryKey:[Ue.e.GET_USER_IS_IN_PAIR_ROOM],queryFn:()=>(async e=>{const t=await g.A.get({url:`undefined/member/${e}/exists`,errorMessage:x.U.GET_USER_IS_IN_PAIR_ROOM});return await t.json()})(e),enabled:!!e});return{isUserInPairRoom:t?.exists,isUserInPairRoomFetching:i}})(e),{isUserRetrospectExists:s,isUserRetrospectExistsFetching:a}=(e=>{const{data:t,isFetching:i}=(0,De.I)({queryKey:[Ue.e.GET_USER_RETROSPECT_EXISTS],queryFn:()=>(async e=>{const t=await g.A.get({url:`undefined/member/retrospect/${e}/exists`,errorMessage:x.U.GET_USER_RETROSPECT_EXISTS});return await t.json()})(e),enabled:!!e});return{isUserRetrospectExists:t?.existRetrospect,isUserRetrospectExistsFetching:i}})(e);return n||a?(0,r.jsxs)(Be,{children:[(0,r.jsx)($e.A,{size:"lg",disabled:!0,children:"회고 작성"}),(0,r.jsx)(qe,{children:"잠시만 기다려주세요..."})]}):"SIGNED_IN"===i&&o?(0,r.jsxs)(Be,{children:[(0,r.jsx)($e.A,{size:"lg",onClick:async()=>{t(s?`/room/${e}/retrospect`:`/room/${e}/retrospectForm`,{state:{valid:!0}})},children:s?"회고 확인":"회고 작성"}),(0,r.jsx)(qe,{children:s?"작성된 회고를 확인하러 가볼까요?":"이번 페어 프로그래밍은 어떠셨나요? 회고를 작성해 주세요."})]}):(0,r.jsxs)(Be,{children:[(0,r.jsx)($e.A,{size:"lg",disabled:!0,children:"회고 작성"}),(0,r.jsx)(qe,{children:"로그인 후 현재 페어룸에 등록된 사람만 회고를 작성할 수 있어요."})]})},Ke=h.Ay.div`
  display: flex;
  align-items: center;
  gap: 0.8rem;
  ...
  font-size: ${({theme:e})=>e.fontSize.lg};
`,Ve=()=>(0,r.jsxs)(Ke,{children:[(0,r.jsx)(be.tF0,{size:ve.w.fontSize.h6,color:ve.w.color.primary[700]}),(0,r.jsx)("p",{children:"투두 리스트"})]}),Xe=h.Ay.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
  gap: 1.2rem;
...
`,et=({todo:e})=>{const[t,i]=(0,o.useState)(!1),[,n]=(0,P.A)(),{isChecked:s,content:a}=e;return(0,r.jsxs)(Xe,{$isChecked:s,$isIconHovered:t,children:[(0,r.jsx)(Ze,{$isChecked:s,children:(0,r.jsx)("p",{children:a})}),(0,r.jsx)(Je,{children:(0,r.jsx)(Qe,{$isChecked:s,onMouseEnter:()=>i(!0),onMouseLeave:()=>i(!1),onClick:()=>n(a)})})]})},tt=h.Ay.div`
  display: flex;
  flex-grow: 1;
  flex-direction: column;
  gap: 1.5rem;
...
`,ot=h.Ay.p`
  color: ${({theme:e})=>e.color.black[400]};
  font-size: ${({theme:e})=>e.fontSize.md};
`,nt=()=>{const{accessCode:e}=(0,u.g)(),{todos:t}=(e=>{const{data:t}=(0,De.I)({queryKey:[Ue.e.GET_TODOS],queryFn:()=>(async e=>{const t=await g.A.get({url:`undefined/${e}/todos`,errorMessage:x.U.GET_TODOS});return await t.json()})(e)});return{todos:t||[]}})(e||"");return(0,r.jsx)(tt,{children:t.length>0?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(rt,{children:["총 ",t.length,"개"]}),(0,r.jsx)(it,{children:t.map((e=>(0,r.jsx)(et,{todo:e},e.id)))})]}):(0,r.jsx)(ot,{children:"저장된 투두 리스트가 없습니다."})})},st=h.Ay.div`
  width: 50%;
  min-width: 45rem;
`,at=h.Ay.div`
  display: flex;
  ...
  border-top: 1px solid ${({theme:e})=>e.color.black[300]};
`,lt=()=>(0,r.jsx)(st,{children:(0,r.jsxs)(Me.q,{children:[(0,r.jsx)(Ve,{}),(0,r.jsx)(at,{children:(0,r.jsx)(nt,{})})]})});var ct=i(3795);const dt=h.Ay.div`
  display: flex;
  justify-content: center;
  align-items: center;
  gap: 4rem;
...
`,bt=h.Ay.img`
  width: 2rem;
  height: 2rem;
`,$t=()=>{const{accessCode:e}=(0,u.g)(),{driver:t,navigator:i,missionUrl:o,isFetching:n}=(0,ct.A)(e||"");return n?(0,r.jsx)(ce.A,{}):(0,r.jsxs)(dt,{children:[(0,r.jsxs)(mt,{children:[(0,r.jsxs)(ut,{children:[(0,r.jsx)(pt,{children:e}),(0,r.jsxs)(ft,{children:[(0,r.jsx)(gt,{children:t}),"와(과) ",(0,r.jsx)(xt,{children:i}),"의 기록이에요"]})]}),o&&(0,r.jsx)(c.N_,{to:o,target:"_blank",children:(0,r.jsxs)(yt,{children:[(0,r.jsx)(bt,{src:le.qZ}),"미션 리포지토리로 이동"]})}),(0,r.jsx)(Ye,{accessCode:e||""})]}),(0,r.jsxs)(ht,{children:[(0,r.jsx)(lt,{}),(0,r.jsx)(Le,{accessCode:e||""})]})]})},vt=h.Ay.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 6rem;
...
`,At=h.Ay.p`
  ...
  line-height: 1.5;
  text-align: center;
`,St=()=>(0,r.jsxs)(vt,{children:[(0,r.jsxs)(wt,{children:[(0,r.jsx)(jt,{children:"404"}),(0,r.jsx)(At,{children:"페이지를 불러오는 중 문제가 발생했습니다."})]}),(0,r.jsx)(c.N_,{to:"/",children:(0,r.jsx)($e.A,{fontWeight:ve.w.fontSize.md,size:"lg","aria-label":"홈으로 이동",children:"홈으로 이동"})})]}),Et=h.Ay.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
...
`,Vt=h.Ay.img`
  ...
  height: 32rem;
  margin-top: 2rem;
`,Xt=()=>(0,r.jsxs)(Dt,{id:"how-to-pair",children:[(0,r.jsx)(Ct,{animationDirection:"right",animationDuration:.7,intersectionObserverOptions:{threshold:.5},children:(0,r.jsx)(Wt,{$textAlign:"center",children:(0,r.jsxs)(Ht,{children:[(0,r.jsx)(Lt,{children:"페어 프로그래밍이란?"}),(0,r.jsxs)(Bt,{children:[(0,r.jsx)(Yt,{children:"페어 프로그래밍(Pair Programming)"}),"은 두 명의 프로그래머가 한 컴퓨터에서 함께 작업하며 소프트웨어 코드를 작성하는 협업 방식입니다."]}),(0,r.jsxs)(Bt,{children:["페어 프로그래밍에서는 두 사람이 각각 ",(0,r.jsx)(Yt,{children:"'드라이버(Driver)'"})," 와",(0,r.jsx)(Yt,{children:" '내비게이터(Navigator)'"})," 역할을 번갈아 가며 수행합니다:"]})]})})}),(0,r.jsx)(Ct,{animationDirection:"left",animationDuration:.7,intersectionObserverOptions:{threshold:.5},children:(0,r.jsxs)(Ut,{children:[(0,r.jsxs)(Gt,{children:[(0,r.jsx)(qt,{children:"드라이버"}),"실제로 코드를 작성하는 사람으로,",(0,r.jsx)("br",{}),"내비게이터의 설계에 따라",(0,r.jsx)("br",{})," 코드를 타이핑합니다."]}),(0,r.jsxs)(Gt,{children:[(0,r.jsx)(qt,{children:"내비게이터"}),"작성된 코드를 실시간으로 검토하고",(0,r.jsx)("br",{}),"개선할 부분을 제안하며,",(0,r.jsx)("br",{}),"코드의 전반적인 구조를 설계합니다."]})]})}),(0,r.jsx)(Ct,{animationDirection:"right",animationDuration:.7,intersectionObserverOptions:{threshold:.5},children:(0,r.jsxs)(Wt,{$textAlign:"right",children:[(0,r.jsx)(Vt,{alt:"",src:le.mD}),(0,r.jsxs)(Ht,{children:[(0,r.jsx)(Lt,{children:"왜 페어 프로그래밍을 해야 할까요?"}),(0,r.jsxs)(Bt,{children:["서로의 대화를 통해 자연스럽게 코드 리뷰가 이루어져",(0,r.jsx)(Yt,{children:" 오류를 조기에 발견하고 수정"}),"할 수 있습니다.",(0,r.jsx)("br",{}),"또한 ",(0,r.jsx)(Yt,{children:"서로 다른 시각"}),"에서 문제를 바라보며 더 창의적이고 효율적인 해결책을 찾을 수 있습니다."]})]})]})}),(0,r.jsx)(Ct,{animationDirection:"left",animationDuration:.7,intersectionObserverOptions:{threshold:.5},children:(0,r.jsxs)(Wt,{children:[(0,r.jsxs)(Ht,{children:[(0,r.jsx)(Lt,{children:"페어 프로그래밍의 방법"}),(0,r.jsxs)(Bt,{children:["서로 일정한 시간 간격으로 역할을 교환하며 ",(0,r.jsx)(Yt,{children:"지속적인 대화"}),"를 통해 코드의 질을 향상시킵니다. ",(0,r.jsx)("br",{})," 또한 주기적으로 작업 과정을 되돌아보고 개선점을 논의하여 다음 세션에서"," ",(0,r.jsx)(Yt,{children:"더 나은 협업"}),"을 할 수 있도록 합니다."]})]}),(0,r.jsx)(Vt,{alt:"",src:le.PU})]})}),(0,r.jsx)(Ct,{animationDirection:"top",animationDuration:.7,intersectionObserverOptions:{threshold:.5},children:(0,r.jsxs)(Kt,{children:["페어 프로그래밍은 단순히 코드를 함께 작성하는 것을 넘어,",(0,r.jsx)("br",{})," 협업을 통해 더 나은 코드를 만들어 나가는 과정입니다.",(0,r.jsx)("br",{}),"이를 통해 개발자들은 서로 배우고 성장하며, 더 나은 결과를 도출할 수 있습니다."]})})]}),Zt=()=>{const e=(0,u.Zp)();(0,o.useEffect)((()=>{const t=t=>{t.preventDefault(),e(1)};return window.addEventListener("popstate",t),window.history.pushState(null,"",window.location.href),()=>{window.removeEventListener("popstate",t)}}),[e])},Jt=()=>({handleSignInGithub:async()=>{const e=await(async()=>{const e=await g.A.get({url:"undefined/sign-in/oauth/github",errorMessage:x.U.SIGN_IN});return await e.json()})();window.location.href=e.endpoint}});var Qt=i(2657);const ei=[{id:"landing",position:"top"},{id:"how-to-pair",position:"bottom"}],ti=()=>{const e=(0,u.Zp)(),{userStatus:t}=(0,f.A)();(0,o.useEffect)((()=>{"SIGNED_IN"===t&&e("/main")}),[t]);const{handleSignInGithub:i}=Jt();return(0,Qt.A)(),Zt(),(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(Et,{id:"landing",children:[(0,r.jsx)(Ct,{animationDirection:"right",children:(0,r.jsx)(kt,{children:"당신의 첫 번째 페어 프로그래밍,"})}),(0,r.jsx)(Ct,{animationDirection:"right",animationDelay:.75,children:(0,r.jsx)(Rt,{src:le.Xo,alt:"코딩해듀오 로고"})}),(0,r.jsxs)(Ot,{children:[(0,r.jsx)(Ct,{animationDirection:"top",animationDelay:2,children:(0,r.jsxs)($e.A,{size:"xl",width:"26rem",color:"#000000",onClick:i,children:[(0,r.jsx)(zt,{src:le.qZ,alt:""}),"Github로 로그인"]})}),(0,r.jsx)(Ct,{animationDirection:"top",animationDelay:2.1,children:(0,r.jsx)($e.A,{size:"xl",width:"26rem",color:"primary",onClick:()=>e("/main"),children:"회원가입 없이 사용하기"})})]})]}),(0,r.jsx)(Xt,{}),(0,r.jsx)(Pt,{targetSections:ei})]})};var ii=i(8027),ri=i(6872);const oi=h.Ay.button`
  ${({$size:e})=>h.AH`
  ...
  ${({$css:e})=>e}
`,ni=({text:e,size:t="base",$css:i,color:o=ve.w.color.black[800],disabled:n=!1,underline:s=!1,hoverType:a="LIGHT",...l})=>(0,r.jsx)(oi,{$css:i,$size:t,$color:o,$underline:s,$hoverType:a,disabled:n,...l,children:e}),si=h.Ay.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
...
`,mi=()=>{const{username:e,userStatus:t}=(0,f.A)(),{handleSignInGithub:i}=Jt(),{handleSignOut:o}=(()=>{const e=(0,u.Zp)(),{setUser:t}=(0,f.A)();return{handleSignOut:async()=>{await(async()=>{await g.A.get({url:"undefined/sign-out",errorMessage:x.U.SIGN_OUT})})(),t("","SIGNED_OUT"),document.cookie="whoami=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;",e("/")}}})();return(0,r.jsxs)(si,{children:[(0,r.jsx)(c.N_,{to:"/","aria-label":"메인 페이지로 이동",children:(0,r.jsx)(ai,{src:le.f,alt:""})}),(0,r.jsxs)(li,{children:[(0,r.jsx)(ci,{to:"/coduo-docs","aria-label":"코딩해듀오 가이드북으로 이동",children:(0,r.jsx)(ni,{text:"코딩해듀오 가이드북"})}),(0,r.jsx)(di,{children:(0,r.jsx)(c.N_,{to:"/coduo-docs","aria-label":"코딩해듀오 가이드북으로 이동",children:(0,r.jsx)(ri.A,{icon:(0,r.jsx)(ii.vd0,{size:ve.w.iconSize.sm,"aria-hidden":"true"}),size:"sm"})})}),"SIGNED_IN"===t?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(ni,{text:"로그아웃",onClick:o}),(0,r.jsx)(c.N_,{to:"/my-page","aria-label":`${e}의 마이페이지로 이동`,children:(0,r.jsx)("span",{"aria-hidden":"true",children:e})})]}):(0,r.jsx)(ni,{text:"Github로 로그인",onClick:i})]})]})};var hi=i(961);const ui=h.i7`
  from {
...
`,gi={SUCCESS:h.AH`
  ...
  animation:
    ${({$isOpen:e})=>e?ui:pi} 0.8s none,
    ${({$isPush:e})=>e&&fi} 0.5s none;

  ${({$status:e})=>gi[e]};
`,yi={SUCCESS:"✅",INFO:"📖",WARNING:"👀",ERROR:"⛔️"},bi=({isOpen:e,isPush:t,message:i,status:o="ERROR"})=>(0,r.jsxs)(xi,{role:"alert","aria-live":"assertive",$isOpen:e,$isPush:t,$status:o,children:[(0,r.jsx)("p",{"aria-hidden":"true",children:yi[o]}),(0,r.jsx)("p",{children:i})]}),$i=h.Ay.div`
  display: flex;
  flex-direction: column;
  gap: 0.6rem;
  ...
  right: 2rem;
  z-index: ${It.M.TOAST};
`,vi=()=>{const{toastList:e}=(0,me.A)();return(0,hi.createPortal)((0,r.jsx)($i,{children:e.map((e=>(0,r.jsx)(bi,{isOpen:e.isOpen,isPush:e.isPush,message:e.message,status:e.status},e.id)))}),document.body)},wi=h.Ay.div`
  display: flex;
  flex-direction: column;
  overflow: hidden;
...
`,ji=h.Ay.main`
  margin-top: 7rem;
`,Ai=()=>(0,r.jsxs)(wi,{children:[(0,r.jsx)(mi,{}),(0,r.jsx)(ji,{role:"presentation",children:(0,r.jsx)(u.sv,{})}),(0,r.jsx)(vi,{})]}),Si=h.Ay.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
  gap: 4rem;
...
`;const _i=h.Ay.div`
  ...
  width: 100%;
  margin-top: 2.5rem;
`,Ii=({isOpen:e,closeModal:t})=>{const{buttonRef:i}=(0,Ci.A)(e);return(0,r.jsxs)(de.a,{isOpen:e,close:t,size:"60rem",children:[(0,r.jsx)(de.a.Header,{title:"페어룸 선택",subTitle:"어떤 방식으로 페어룸을 만들까요?"}),(0,r.jsxs)(_i,{children:[(0,r.jsx)(c.N_,{to:"/onboarding?mission=false","aria-label":"미션 없이 그냥 시작할래요",children:(0,r.jsx)($e.A,{size:"lg",width:"100%",height:"6rem",fontSize:ve.w.fontSize.lg,color:"secondary",filled:!1,children:"그냥 시작할래요"})}),(0,r.jsx)(c.N_,{to:"/onboarding?mission=true","aria-label":"코딩해듀오가 깃허브 리포지토리로 제공하는 미션과 함께 시작할래요",children:(0,r.jsx)($e.A,{ref:i,size:"lg",width:"100%",height:"6rem",fontSize:ve.w.fontSize.lg,color:"secondary",children:"미션과 함께 시작할래요"})})]}),(0,r.jsx)(de.a.CloseButton,{close:t})]})};var Ni=i(7545),Mi=i(462),Fi=i(3847);const Pi=({isOpen:e,closeModal:t})=>{const i=(0,u.Zp)(),{addToast:o}=(0,me.A)(),{value:n,resetValue:s,handleChange:a}=(0,Fi.A)(),{buttonRef:l}=(0,Ci.A)(e);return(0,r.jsxs)(de.a,{isOpen:e,close:t,size:"60rem",children:[(0,r.jsx)(de.a.Header,{title:"페어룸 참가하기"}),(0,r.jsx)(de.a.Body,{children:(0,r.jsxs)(Ni.F,{children:[(0,r.jsx)(Ni.F.Label,{children:"페어룸 참가 코드"}),(0,r.jsx)(Ni.F.Input,{onChange:a,value:n,placeholder:"코드를 입력해 주세요",onReset:()=>s()})]})}),(0,r.jsxs)(de.a.Footer,{children:[(0,r.jsx)($e.A,{size:"lg",onClick:t,filled:!1,children:"닫기"}),(0,r.jsx)($e.A,{ref:l,size:"lg",disabled:!n,onClick:async()=>{const{exists:e}=await(0,Mi.C_)(n);e?i(`/room/${n}`,{state:{valid:!0},replace:!0}):o({status:"ERROR",message:"해당 코드와 일치하는 방이 없습니다."})},children:"완료"})]}),(0,r.jsx)(de.a.CloseButton,{close:t})]})},Di=h.i7`
...
`,Wi=(0,h.Ay)(Gi)`
  ...
  animation: ${Di} 40s infinite linear;
`,Hi=(0,h.Ay)(Gi)`
  background: ${({theme:e})=>e.color.primary[100]};

  animation: ${Di} 13s infinite linear;
`,Li=()=>(0,r.jsxs)(Ui,{children:[(0,r.jsx)(Wi,{}),(0,r.jsx)(Hi,{})]}),Bi=()=>{Zt();const{isModalOpen:e,openModal:t,closeModal:i}=(0,Fe.A)(),{isModalOpen:o,openModal:n,closeModal:s}=(0,Fe.A)();return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(Li,{}),(0,r.jsxs)(Si,{children:[(0,r.jsx)(Ct,{animationDirection:"right",children:(0,r.jsxs)(Ei,{children:[(0,r.jsxs)(ki,{role:"presentation",children:[(0,r.jsx)(Ri,{"aria-label":"협업과 성장을 위한 페어 프로그래밍",children:(0,r.jsxs)("p",{"aria-hidden":!0,children:[(0,r.jsx)("span",{children:"협업"}),"과 ",(0,r.jsx)("span",{children:"성장"}),"을 위한",(0,r.jsx)("br",{}),(0,r.jsx)("span",{children:"페어 프로그래밍-"})]})}),(0,r.jsx)(zi,{"aria-label":"코딩해듀오",children:(0,r.jsxs)("p",{"aria-hidden":!0,children:["코딩해",(0,r.jsx)("span",{children:"듀오"})]})})]}),(0,r.jsxs)(Oi,{role:"presentation",children:["코딩해듀오는 페어 프로그래밍을 통해 더 나은 결과를 만들어내는 것을 목표로 합니다.",(0,r.jsx)("br",{}),"직관적인 인터페이스와 실시간 협업 도구로, 누구나 쉽게 사용할 수 있습니다."]})]})}),(0,r.jsxs)(Ti,{children:[(0,r.jsx)(Ct,{animationDirection:"left",animationDelay:.2,children:(0,r.jsx)($e.A,{size:"xl",borderRadius:"6rem",onClick:t,children:"페어룸 만들기"})}),(0,r.jsx)(Ct,{animationDirection:"left",animationDelay:.4,children:(0,r.jsx)($e.A,{size:"xl",borderRadius:"6rem",filled:!1,onClick:n,children:"페어룸 들어가기"})})]}),(0,r.jsx)(Ii,{isOpen:e,closeModal:i}),(0,r.jsx)(Pi,{isOpen:o,closeModal:s})]})]})};var qi=i(57);const Yi=h.Ay.p`
  margin-top: 5rem;

  color: ${({theme:e})=>e.color.black[400]};
  font-size: ${({theme:e})=>e.fontSize.base};
`,Ki=({isFetching:e,length:t,emptyMessage:i,children:o})=>e?(0,r.jsx)(p.A,{}):t<1?(0,r.jsx)(Yi,{children:i}):(0,r.jsx)(r.Fragment,{children:o}),Vi=[{key:"pairRoom",title:"나의 페어룸"},{key:"retrospect",title:"나의 회고"}],Xi=h.Ay.button`
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,Zi=h.Ay.div`
  ...
  width: 100%;
`,Ji=({length:e,currentTab:t,handleTabClick:i})=>(0,r.jsx)(Zi,{children:Vi.map(((o,n)=>(0,r.jsx)(Xi,{onClick:()=>i(o.key),$isActive:t===o.key,children:(0,r.jsxs)("p",{children:[o.title," (",e[n],")"]})},o.key)))});var Qi=i(4700);const er=h.i7`
  0% {
...
`,mr=(h.Ay.span`
  ...
  font-size: ${({theme:e})=>e.fontSize.base};
  line-height: 1.5;
`,({driver:e,navigator:t,status:i,accessCode:o})=>{const{openModal:n,closeModal:s,isModalOpen:a}=(0,Fe.A)(),{deletePairRoomMutation:l,isDeletePairRoomPending:c}=(0,Qi.A)();return c?(0,r.jsx)(rr,{children:(0,r.jsx)(p.A,{})}):(0,r.jsxs)(rr,{children:[(0,r.jsx)(or,{to:`/room/${o}`,state:{valid:!0},replace:!0,children:(0,r.jsxs)(cr,{$status:i,$color:"secondary",children:[(0,r.jsxs)(sr,{children:[(0,r.jsxs)(ar,{$status:i,$color:"secondary",children:[(0,r.jsx)("span",{children:"드라이버"}),e]}),(0,r.jsxs)(ar,{$status:i,$color:"secondary",children:[(0,r.jsx)("span",{children:"내비게이터"}),t]})]}),(0,r.jsx)(nr,{$status:i,children:"IN_PROGRESS"===i?"진행 중":"진행 완료"}),(0,r.jsxs)(lr,{children:["입장",(0,r.jsx)(be.OQo,{size:"1.8rem"})]})]})}),(0,r.jsx)(dr,{onClick:e=>{e.preventDefault(),e.stopPropagation(),n()}}),(0,r.jsx)(qi.A,{isOpen:a,close:s,title:"정말 삭제하시겠습니까?",subTitle:"투두 리스트, 레퍼런스 링크 등 모든 데이터가 삭제됩니다.",confirmText:"삭제하기",onConfirm:async()=>{l({accessCode:o}),s()}})]})});var hr=i(7097);const ur=async({accessCode:e,answers:t})=>{await g.A.post({url:"undefined/retrospects",body:JSON.stringify({accessCode:e,answers:t}),errorMessage:x.U.ADD_RETROSPECT})},pr=async({accessCode:e})=>{await g.A.delete({url:`undefined/retrospects/${e}`,errorMessage:x.U.DELETE_RETROSPECT})},fr=()=>{const e=(0,m.jE)(),{addToast:t}=(0,me.A)(),{mutate:i}=(0,hr.n)({mutationFn:ur,onSuccess:()=>t({status:"SUCCESS",message:"회고 작성이 완료되었습니다."}),onError:e=>t({status:"ERROR",message:e.message})}),{mutate:r}=(0,hr.n)({mutationFn:pr,onSuccess:()=>e.invalidateQueries({queryKey:[Ue.e.GET_MY_RETROSPECTS]}),onError:e=>t({status:"ERROR",message:e.message})});return{addRetrospectMutation:i,deleteRetrospectMutation:r}},gr=({accessCode:e,answer:t})=>{const{openModal:i,closeModal:o,isModalOpen:n}=(0,Fe.A)(),{deleteRetrospectMutation:s}=fr();return(0,r.jsxs)(rr,{children:[(0,r.jsx)(or,{to:`/room/${e}/retrospect`,state:{valid:!0},children:(0,r.jsxs)(cr,{$status:"IN_PROGRESS",$color:"primary",children:[(0,r.jsx)(sr,{children:(0,r.jsxs)(ar,{$status:"IN_PROGRESS",$color:"primary",children:[(0,r.jsx)("span",{children:e}),(e=>e.length>10?e.slice(0,10)+"...":e)(t)]})}),(0,r.jsxs)(lr,{children:["보기",(0,r.jsx)(be.OQo,{size:"1.8rem"})]})]})}),(0,r.jsx)(dr,{onClick:e=>{e.preventDefault(),e.stopPropagation(),i()}}),(0,r.jsx)(qi.A,{isOpen:n,close:o,title:"정말 삭제하시겠습니까?",subTitle:"해당 회고의 모든 내용이 삭제됩니다.",confirmText:"삭제하기",onConfirm:async()=>{s({accessCode:e}),o()}})]})},xr=()=>{const[e,t]=(0,o.useState)("pairRoom"),{myPairRooms:i,isMyPairRoomsFetching:n}=(()=>{const{data:e,isFetching:t}=(0,De.I)({queryKey:[Ue.e.GET_MY_PAIR_ROOMS],queryFn:v,retry:!1,refetchOnWindowFocus:!1});return{myPairRooms:e,isMyPairRoomsFetching:t}})(),{myRetrospects:s,isMyRetrospectsFetching:a}=(()=>{const{data:e,isFetching:t}=(0,De.I)({queryKey:[Ue.e.GET_MY_RETROSPECTS],queryFn:w,retry:!1});return{myRetrospects:e?.retrospects||[],isMyRetrospectsFetching:t}})(),l=i?.length||0,c=s?.length||0;return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(Ji,{length:[l,c],currentTab:e,handleTabClick:e=>{t(e)}}),e===Vi[0].key&&(0,r.jsx)(Ki,{length:l,emptyMessage:"생성한 페어룸이 없습니다.",isFetching:n,children:i?.map((e=>(0,r.jsx)(mr,{driver:e.driver,navigator:e.navigator,status:e.status,accessCode:e.accessCode},e.id)))}),e===Vi[1].key&&(0,r.jsx)(Ki,{length:c,emptyMessage:"작성한 회고가 없습니다.",isFetching:a,children:s?.map((e=>(0,r.jsx)(gr,{answer:e.answer,accessCode:e.accessCode},e.accessCode)))})]})},yr=h.Ay.div`
  display: flex;
  justify-content: center;
`,br=h.Ay.div`
  display: flex;
...
`),Sr=(h.Ay.div`
  margin: 1rem 0;
  border: 1px solid ${({theme:e})=>e.color.black[300]};
`,()=>{const{username:e}=(0,f.A)(),{isModalOpen:t,openModal:i,closeModal:o}=(0,Fe.A)(),{deleteMemberMutation:n}=(()=>{const e=(0,u.Zp)(),{resetUser:t}=(0,f.A)(),{addToast:i}=(0,me.A)(),{mutate:r,isSuccess:o}=(0,hr.n)({mutationFn:$,onSuccess:()=>{t(),i({status:"SUCCESS",message:"지금까지 코딩해듀오와 함께 해 주셔서 감사해요. 다음에 또 만나요 👋🏻"}),e("/",{replace:!0})},onError:e=>i({status:"ERROR",message:e.message})});return{deleteMemberMutation:r,isSuccess:o}})();return(0,r.jsxs)(yr,{children:[(0,r.jsxs)(br,{children:[(0,r.jsxs)($r,{children:[(0,r.jsx)(vr,{children:"마이 페이지"}),(0,r.jsxs)(wr,{children:[(0,r.jsx)("span",{children:e})," 님의 마이 페이지에 오신 걸 환영합니다!"]})]}),(0,r.jsx)(jr,{children:(0,r.jsx)(xr,{})}),(0,r.jsxs)(Ar,{onClick:i,children:["회원 탈퇴하기",(0,r.jsx)(be.OQo,{size:"1.5rem"})]})]}),(0,r.jsx)(qi.A,{isOpen:t,close:o,title:"정말 탈퇴하시겠습니까?",subTitle:"해당 작업은 다시 복구할 수 없습니다.",confirmText:"탈퇴하기",onConfirm:n})]})});var Er=i(6007),kr=i(4251);const Rr=new Er.E({auth:void 0}),zr="coduo-missions",Or=async({repositoryName:e,branchName:t,sha:i})=>{try{return await Rr.request(`POST /repos/${zr}/${e}/git/refs`,{ref:`refs/heads/${t}`,sha:i})}catch(e){if(e instanceof Error)throw new Error(e.message);kr.Cp(e)}};var Tr=i(6973);const Cr=h.Ay.div`
  display: flex;
  flex-direction: column;
  gap: 3rem;
`,_r=h.Ay.div`
...
`,Ur=(0,h.Ay)(Tr.zDP)`
  ...
  color: ${({theme:e})=>e.color.black[800]};
  font-size: ${({theme:e})=>e.fontSize.lg};
`,Gr=({repositoryName:e,branchName:t,onBranchName:i})=>{const{branches:o}=(e=>{const{data:t}=(0,De.I)({queryKey:[Ue.e.GET_BRANCHES,e],queryFn:()=>(async e=>{try{return(await Rr.request(`GET /repos/${zr}/${e}/branches`,{headers:{"X-GitHub-Api-Version":"2022-11-28"}})).data}catch(e){if(e instanceof Error)throw new Error(e.message);kr.Cp(e)}})(e)});return{branches:t?.map((e=>e.name))||[]}})(e);return(0,r.jsxs)(Cr,{"aria-label":`${e} 레포지토리가 선택되었습니다. 총 2개의 설정 항목 중 2번째 항목입니다.`,children:[(0,r.jsxs)(_r,{children:[(0,r.jsx)(Ir,{children:e}),(0,r.jsx)(Nr,{children:"미션을 시작할 브랜치 이름을 입력해 주세요."})]}),(0,r.jsxs)(Mr,{children:[(0,r.jsxs)(Fr,{"aria-hidden":"true",children:[(0,r.jsx)(Pr,{src:le.qZ,alt:""}),e]}),(0,r.jsxs)(Dr,{children:[(0,r.jsx)(Ur,{"aria-hidden":"true"}),(0,r.jsxs)(Ni.F,{children:[(0,r.jsx)(Ni.F.Input,{autoFocus:!0,placeholder:"미션에서 사용할 브랜치 이름을 입력해 주세요.",value:t.value,status:t.status,onChange:e=>i(e,o)}),(0,r.jsx)(Ni.F.Message,{status:t.status,children:t.message})]})]})]})]})},Wr=h.Ay.div`
  display: flex;
  flex-direction: column;
  gap: 1rem 0;
...
`,Lr=h.Ay.p`
  ...
  font-weight: ${({theme:e})=>e.fontWeight.normal};
  line-height: 1.6;
`,Br=({title:e,description:t})=>(0,r.jsxs)(Wr,{role:"presentation",children:[e&&(0,r.jsxs)(Hr,{children:[(0,r.jsx)(_t.qTh,{size:"2rem","aria-hidden":"true"}),e]}),(0,r.jsx)(Lr,{children:t})]}),qr=h.Ay.div`
  display: flex;
  flex-direction: column;
...
`,Xr=({id:e,name:t,onSelect:i})=>(0,r.jsxs)(qr,{children:[(0,r.jsx)($e.A,{width:"30rem",borderRadius:"5px",color:"#000000",fontSize:ve.w.fontSize.md,fontWeight:"medium",textAlign:"right",name:t,animation:!1,onClick:e=>i(e.currentTarget.name),children:(0,r.jsxs)(Yr,{children:[(0,r.jsx)(Kr,{src:le.qZ,alt:""}),t]})},e),(0,r.jsxs)(Vr,{to:`https://github.com/coduo-missions/${t}`,target:"_blank","aria-label":`${t} 레포지토리로 이동하기`,children:["리포지토리로 이동하기",(0,r.jsx)(be.OQo,{})]})]}),Zr=h.Ay.div`
  display: flex;
  flex-direction: column;
  gap: 3rem;
`,Jr=h.Ay.div`
...
`,h.Ay.p`
  ...
  font-size: ${({theme:e})=>e.fontSize.sm};
`,({onSelect:e})=>{const{repositories:t,isFetching:i}=(()=>{const{data:e,isFetching:t,error:i}=(0,De.I)({queryKey:[Ue.e.GET_REPOSITORIES],queryFn:()=>(async()=>{try{return(await Rr.request(`GET /orgs/${zr}/repos`,{org:"ORG",headers:{"X-GitHub-Api-Version":"2022-11-28"}})).data}catch(e){if(e instanceof Error)throw new Error(e.message);kr.Cp(e)}})(),refetchOnWindowFocus:!1});return{repositories:e?.filter((e=>e.name.startsWith("coduo")))||[],isFetching:t,error:i}})();return(0,r.jsxs)(Zr,{"aria-label":"총 2개의 설정 항목 중 1번째 항목입니다.",children:[(0,r.jsxs)(to,{children:[(0,r.jsxs)(Jr,{children:[(0,r.jsx)(Qr,{children:"미션 선택"}),(0,r.jsx)(eo,{children:"구현해 볼 미션 레포지토리를 선택해 주세요."})]}),(0,r.jsx)(Br,{title:"어떻게 미션을 선택할 수 있나요?",description:"미션을 선택하고 해당 미션 레포지토리에 원하는 이름으로 브랜치를 생성하세요. 생성된 브랜치로 이동하여 미션 코드를 관리할 수 있습니다."})]}),(0,r.jsx)(io,{children:i?(0,r.jsx)(p.A,{size:"sm"}):t.map((t=>(0,r.jsx)(Xr,{id:t.id,name:t.name,onSelect:e},t.id)))})]})}),oo=(e,t)=>{const[i,r]=(0,o.useState)(e);return(0,o.useEffect)((()=>{const i=setTimeout((()=>r(e)),t);return()=>clearTimeout(i)}),[e]),i},no=(e,t)=>{const[i,r]=(0,o.useState)(e);var n;return t.some(Boolean)&&(n=e+t.filter(Boolean).length)>i&&r(n),(0,o.useEffect)((()=>{window.scrollTo({top:document.body.scrollHeight,behavior:"smooth"})}),[i]),{moveIndex:i}},so=h.Ay.div`
  display: flex;
  flex-direction: column;
  gap: 8rem;
`,ao=h.Ay.div`
  ...
  width: 100%;
  margin-top: 5rem;
`,lo=({repositoryName:e,onRepositoryName:t,onAddBranch:i})=>{const{branchName:o,isValidBranchName:n,resetBranchName:s,handleBranchName:a}=(()=>{const{value:e,status:t,message:i,handleChange:r,resetValue:o}=(0,Fi.A)();return{branchName:{value:e,status:t,message:i},isValidBranchName:"DEFAULT"===t&&""!==e&&e.length<=30,resetBranchName:o,handleBranchName:(e,t)=>{return r(e,(o=t,""===(i=e.target.value).trim()?{status:"ERROR",message:"값을 입력해 주세요."}:i.length>30?{status:"ERROR",message:"30자 이하로 입력해 주세요."}:o.includes(i)?{status:"ERROR",message:"중복된 브랜치 이름 입니다."}:{status:"DEFAULT",message:""}));var i,o}}})(),{moveIndex:l}=no(0,[""!==e,oo(n,500)]);return(0,r.jsxs)(so,{"aria-label":"해당 섹션에서는 미션 레포지토리를 선택하고 브랜치 이름을 설정할 수 있습니다.",children:[(0,r.jsx)(ro,{onSelect:e=>{t(e),s()}}),l>=1&&(0,r.jsx)(Gr,{repositoryName:e,branchName:o,onBranchName:a}),l>=2&&(0,r.jsx)(ao,{children:(0,r.jsx)($e.A,{width:"15rem",disabled:!n,onClick:()=>i(e,o.value),children:"브랜치 생성하기"})})]})},co=e=>""===e.trim()?{status:"ERROR",message:"값을 입력해 주세요."}:e.length>10?{status:"ERROR",message:"이름(또는 닉네임)은 10자 이하로 입력해 주세요."}:{status:"DEFAULT",message:""},mo=h.Ay.div`
  margin: 4rem 0;
`,ho=h.Ay.div`
  display: flex;
  gap: 1rem;
  ...
  right: 4rem;
  bottom: 4rem;
`,uo=({isOpen:e,closeModal:t,onPairData:i})=>{const{addToast:o}=(0,me.A)(),{value:n,status:s,message:a,handleChange:l,resetValue:c}=(0,Fi.A)(),{buttonRef:d}=(0,Ci.A)(e),m=()=>{c(),t()};return(0,r.jsxs)(de.a,{isOpen:e,close:m,size:"60rem",height:"34rem",children:[(0,r.jsx)(de.a.Header,{title:"페어 정보 연동하기"}),(0,r.jsx)(mo,{children:(0,r.jsxs)(Ni.F,{children:[(0,r.jsx)(Ni.F.Label,{children:"페어의 깃허브 아이디"}),(0,r.jsx)(Ni.F.Input,{placeholder:"깃허브 아이디를 입력해 주세요.",value:n,onChange:e=>l(e,""===e.target.value.trim()?{status:"ERROR",message:"값을 입력해 주세요."}:{status:"DEFAULT",message:""})}),(0,r.jsx)(Ni.F.Message,{status:s,children:a})]})}),(0,r.jsxs)(ho,{children:[(0,r.jsx)($e.A,{size:"lg",onClick:m,filled:!1,children:"닫기"}),(0,r.jsx)($e.A,{ref:d,size:"lg",disabled:""===n.trim()||"ERROR"===s,onClick:()=>(async e=>{try{const{memberName:t}=await b(e);i(e,t),m(),o({status:"SUCCESS",message:"페어 정보 연동에 성공했습니다."})}catch(e){e instanceof Error&&o({status:"ERROR",message:e.message})}})(n),children:"연동하기"})]}),(0,r.jsx)(de.a.CloseButton,{close:m})]})},po=h.Ay.div`
  display: flex;
  flex-direction: column;
  gap: 2rem;
`,fo=h.Ay.div`
...
`),bo=({userPairName:e,pairId:t,pairName:i,onUserPairName:n,onPairName:s,openAddPairModal:a})=>{const[l,c]=(0,o.useState)(!!t);return(0,o.useEffect)((()=>{""!==t&&c(!0)}),[t]),(0,r.jsxs)(po,{"aria-label":"총 3개의 설정 항목 중 1번째 항목입니다.",children:[(0,r.jsxs)(fo,{children:[(0,r.jsx)(go,{children:"이름 입력"}),(0,r.jsx)(xo,{children:"나와 페어의 이름을 입력해 주세요."})]}),(0,r.jsxs)(Ni.F,{children:[(0,r.jsx)(Ni.F.Label,{htmlFor:"my-name",children:"나의 이름은 무엇인가요?"}),(0,r.jsx)(Ni.F.Input,{id:"my-name",placeholder:"이름을 입력해 주세요.",value:e.value,status:e.status,onChange:n}),(0,r.jsx)(Ni.F.Message,{status:e.status,children:e.message})]}),(0,r.jsxs)(Ni.F,{children:[(0,r.jsx)(Ni.F.Label,{htmlFor:"pair-name",children:"함께할 페어의 이름은 무엇인가요?"}),l?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(Ni.F.Content,{children:[(0,r.jsx)(Ni.F.Input,{id:"pair-name",autoFocus:!0,placeholder:"이름을 입력해 주세요.",value:i.value,status:i.status,onChange:s}),!t&&(0,r.jsx)($e.A,{color:"primary",borderRadius:"1rem",fontSize:ve.w.fontSize.md,onClick:()=>c(!1),children:"취소"})]}),(0,r.jsx)(Ni.F.Message,{status:i.status,children:i.message})]}):(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(yo,{"aria-label":"페어 정보 연동하기 버튼, 클릭하시면 페어 정보 연동 모달이 열립니다.",onClick:a,children:[(0,r.jsx)("div",{"aria-hidden":"true",children:(0,r.jsx)("img",{src:le.f,alt:""})}),(0,r.jsx)("p",{children:"페어 정보 연동하기"})]}),(0,r.jsx)(ni,{text:"연동 없이 시작하기",onClick:()=>c(!0),underline:!0,color:ve.w.color.black[400],size:"sm",hoverType:"DARK"})]})]})]})};var $o=i(640);const vo=h.Ay.p`
  overflow: hidden;
  ...
  white-space: nowrap;
  clip: rect(0, 0, 0, 0);
`,wo=({children:e})=>(0,r.jsx)(vo,{"aria-live":"polite",children:e}),jo=h.Ay.div`
  display: flex;
  flex-direction: column;
  gap: 3rem;
`,Ao=h.Ay.div`
...
`,Oo=(h.Ay.p`
  ...
  font-size: ${({theme:e})=>e.fontSize.base};
  font-weight: 500;
`,({userPairName:e,pairName:t,driver:i,navigator:n,onPairRole:s})=>{const[a,l]=(0,o.useState)("");(0,o.useEffect)((()=>{i&&n&&l(`현재 설정된 드라이버는 ${i}, 내비게이터는 ${n}입니다.`)}),[i,n]);const c=[{id:"1",value:e},{id:"2",value:t}],d=(e,t)=>{s((0,Ge.r)(c,e)||"",t)};return(0,r.jsxs)(jo,{"aria-label":"총 3개의 설정 항목 중 2번째 항목입니다.",children:[(0,r.jsx)(wo,{"aria-live":"polite",children:a}),(0,r.jsxs)(ko,{children:[(0,r.jsxs)(Ao,{role:"presentation",children:[(0,r.jsx)(So,{children:"역할 설정"}),(0,r.jsx)(Eo,{children:"드라이버 / 내비게이터를 설정해 주세요."})]}),(0,r.jsx)(Br,{title:"드라이버 / 내비게이터가 무엇인가요?",description:"드라이버는 키보드와 마우스를 사용하여 실제로 코드를 작성하는 사람입니다. 내비게이터는 코드의 논리적 흐름, 설계,\n      오류 등을 검토하며, 드라이버에게 피드백을 제공합니다."})]}),(0,r.jsxs)(Ro,{children:[(0,r.jsxs)(zo,{children:[(0,r.jsx)($o.m.Label,{message:"드라이버"}),(0,r.jsx)($o.m,{placeholder:"이름을 선택해주세요.",options:c,selectedOption:i,onSelect:e=>d(e,"DRIVER")})]}),(0,r.jsxs)(zo,{children:[(0,r.jsx)($o.m.Label,{message:"내비게이터"}),(0,r.jsx)($o.m,{placeholder:"이름을 선택해주세요.",options:c,selectedOption:n,onSelect:e=>d(e,"NAVIGATOR")})]})]})]})});var To=i(5260);const Co=h.Ay.div`
  display: flex;
  flex-direction: column;
  gap: 3rem;
`,_o=h.Ay.div`
...
`,Po=h.Ay.div`
  display: flex;
  gap: 0.5rem;
`,Do=[{label:"10분",value:"10"},{label:"15분",value:"15"},{label:"30분",value:"30"}],Uo=({timerDuration:e,onTimerDuration:t})=>{const[i,n]=(0,o.useState)(!1);return(0,r.jsxs)(Co,{"aria-label":"총 3개의 설정 항목 중 3번째 항목입니다.",children:[(0,r.jsxs)(Mo,{children:[(0,r.jsxs)(_o,{children:[(0,r.jsx)(Io,{children:"타이머 설정"}),(0,r.jsx)(No,{children:"타이머 시간을 설정해 주세요."})]}),(0,r.jsx)(Br,{title:"왜 타이머 시간을 설정해야 하나요?",description:"정기적인 역할 교대는 피드백을 주고받을 수 있는 자연스러운 기회를 제공합니다. 이는 코드 품질을 높이고, 문제를\n          조기에 발견하여 수정할 수 있게 합니다."})]}),(0,r.jsxs)(Fo,{children:[Do.map((o=>(0,r.jsx)($e.A,{size:"md",borderRadius:"1rem",color:"primary",filled:e===o.value,onClick:()=>(e=>{i&&n(!1),t(e)})(o.value),children:o.label},o.value))),(0,r.jsxs)(Po,{children:[(0,r.jsx)($e.A,{size:"md",borderRadius:"1rem",color:"primary",filled:i,onClick:()=>{i||n(!0),t("")},children:"직접 설정"},"직접 설정"),i&&(0,r.jsxs)(Ni.F,{gap:"0.5rem",width:"20rem",children:[(0,r.jsx)(Ni.F.Input,{autoFocus:!0,"aria-label":"타이머 시간을 분 단위로 입력해 주세요.",borderRadius:"1rem",height:"4rem",value:e,placeholder:"타이머 시간 (분)",status:(0,To.W)(e)?"DEFAULT":"ERROR",disabled:!i,onChange:e=>{t(e.target.value)}}),(0,r.jsx)(Ni.F.Message,{status:(0,To.W)(e)?"DEFAULT":"ERROR",children:(0,To.W)(e)?"":"1 이상 99 이하의 숫자를 입력해 주세요."})]})]})]})]})},Go=h.Ay.div`
  display: flex;
  flex-direction: column;
  gap: 8rem;
`,Wo=h.Ay.div`
  ...
  width: 100%;
  margin-top: 5rem;
`,Ho=({repositoryName:e})=>{const t=(0,u.Zp)(),{userPairName:i,pairId:n,pairName:s,driver:a,navigator:l,timerDuration:c,isPairRoomNameValid:d,isPairRoleValid:m,isTimerDurationValid:h,handleUserPairName:p,handlePairName:g,handlePairData:x,handlePairRole:y,handleTimerDuration:b}=(()=>{const{username:e,userStatus:t}=(0,f.A)(),[i,r]=(0,o.useState)({value:"SIGNED_IN"===t?e:"",status:"DEFAULT",message:""}),[n,s]=(0,o.useState)({value:"",status:"DEFAULT",message:""}),[a,l]=(0,o.useState)(""),[c,d]=(0,o.useState)(""),[m,h]=(0,o.useState)(""),[u,p]=(0,o.useState)(""),g=""!==i.value&&""!==n.value&&"ERROR"!==i.status&&"ERROR"!==n.status,x=""!==c&&""!==m,y=""!==u&&(0,To.W)(u),b=(e,t)=>{const i=co(e),o=co(t),n=(l=t,""!==(a=e).trim()&&""!==l.trim()&&a.trim()===l.trim()?{status:"ERROR",message:"중복된 이름(또는 닉네임)입니다. "}:{status:"DEFAULT",message:""});var a,l;r({value:e,status:"ERROR"!==i.status?n.status:i.status,message:"ERROR"!==i.status?n.message:i.message}),s({value:t,status:"ERROR"!==o.status?n.status:o.status,message:"ERROR"!==o.status?n.message:o.message})};return{userPairName:i,pairId:a,pairName:n,driver:c,navigator:m,timerDuration:u,isPairRoomNameValid:g,isPairRoleValid:x,isTimerDurationValid:y,handleUserPairName:e=>{i.value!==c&&i.value!==m||(d(""),h("")),b(e.target.value,n.value)},handlePairName:e=>{n.value!==c&&n.value!==m||(d(""),h("")),b(i.value,e.target.value)},handlePairData:(e,t)=>{l(e),b(i.value,t)},handlePairRole:(e,t)=>{const r=i.value===e?n.value:i.value;"DRIVER"===t?(d(e),h(r)):(d(r),h(e))},handleTimerDuration:e=>p(e)}})(),$=[oo(d,500),m,h],{moveIndex:v}=no(0,$),{isModalOpen:w,openModal:j,closeModal:A}=(0,Fe.A)(),{addPairRoomMutation:S}=(0,Qi.A)();return(0,r.jsxs)(Go,{"aria-label":"해당 섹션에서는 당신과 페어의 이름, 드라이버와 네비게이터, 타이머 시간을 설정할 수 있습니다.",children:[(0,r.jsx)(bo,{userPairName:i,pairId:n,pairName:s,onUserPairName:p,onPairName:g,openAddPairModal:j}),(0,r.jsx)(uo,{isOpen:w,closeModal:A,onPairData:x}),v>=1&&(0,r.jsx)(Oo,{userPairName:i.value,pairName:s.value,driver:a,navigator:l,onPairRole:y}),v>=2&&(0,r.jsx)(Uo,{timerDuration:c,onTimerDuration:b}),v>=3&&(0,r.jsx)(Wo,{children:(0,r.jsx)($e.A,{size:"lg",disabled:$.some((e=>!e)),onClick:()=>{S({pairId:n,driver:a,navigator:l,missionUrl:""!==e?`https://github.com/coduo-missions/${e}`:"",timerDuration:60*Number(c)*1e3,timerRemainingTime:60*Number(c)*1e3},{onSuccess:e=>t(`/room/${e}`,{state:{valid:!0},replace:!0})})},children:"완료"})})]})},Lo=h.Ay.div`
  display: flex;
  justify-content: center;
...
`,h.Ay.div`
  ...
  width: 100%;
  margin-top: 5rem;
`,()=>{const e=(0,u.zy)(),t=new URLSearchParams(e.search).get("mission"),[i,n]=(0,o.useState)(""),{handleAddBranch:s,isSuccess:a}=(()=>{const{addToast:e}=(0,me.A)(),{mutate:t,isSuccess:i}=(0,hr.n)({mutationFn:Or,onSuccess:()=>e({status:"SUCCESS",message:"브랜치 생성에 성공했습니다."}),onError:()=>e({status:"ERROR",message:"브랜치 생성에 실패했습니다."})});return{handleAddBranch:async(e,i)=>{const r=await(async e=>{try{return(await Rr.request(`GET /repos/${zr}/${e}/git/refs/heads/main`,{headers:{"X-GitHub-Api-Version":"2022-11-28"}})).data.object.sha}catch(e){if(e instanceof Error)throw new Error(e.message);kr.Cp(e)}})(e);r&&""!=e&&t({repositoryName:e,branchName:i,sha:r})},isSuccess:i}})();return(0,r.jsx)(Lo,{children:(0,r.jsxs)(qo,{children:[(0,r.jsx)(Bo,{children:"true"===t?"미션과 함께 시작하기":"그냥 시작하기"}),"true"===t&&!a&&(0,r.jsx)(lo,{repositoryName:i,onRepositoryName:e=>n(e),onAddBranch:s}),("true"===t&&a||"false"===t)&&(0,r.jsx)(Ho,{repositoryName:i})]})})});var Ko=i(1245);const Vo=()=>{const e=(0,u.zy)(),{accessCode:t}=(0,u.g)(),[i,n]=(0,o.useState)(null),{setAccessCode:s}=(0,Ko.A)(),{addToast:a}=(0,me.A)();return(0,o.useEffect)((()=>{(async()=>{if("/my-page"===e.state?.from)return void n(!0);if(e.state?.from===`/${t}/retrospectForm`)return void n(!0);if(!t||!e.state?.valid)return n(!1),void a({status:"ERROR",message:"유효하지 않은 접근입니다. 올바른 경로로 접근해 주세요."});const{exists:i}=await(0,Mi.C_)(t||"");if(!i)return n(!1),void a({status:"ERROR",message:"유효하지 않은 접근입니다. 올바른 경로로 접근해 주세요."});n(!0)})(),s(t||"")}),[]),null===i?(0,r.jsx)(ce.A,{}):i?(0,r.jsx)(u.sv,{}):(0,r.jsx)(u.C5,{to:"/main",replace:!0})},Xo=h.Ay.div`
  display: flex;
  justify-content: space-between;
`,Zo=h.Ay.div`
  display: flex;
...
`,Qo=h.Ay.h2`
  color: ${({theme:e})=>e.color.primary[800]};
  font-size: ${({theme:e})=>e.fontSize.lg};
`,en=({title:e,subTitle:t,buttonText:i,onButtonClick:o})=>(0,r.jsxs)(Xo,{children:[(0,r.jsxs)(Zo,{children:[(0,r.jsx)(Jo,{children:e}),(0,r.jsx)(Qo,{children:t})]}),(0,r.jsx)($e.A,{width:"11rem",color:"secondary",filled:!1,rounded:!0,size:"sm",onClick:o,children:i})]}),tn=h.Ay.div`
  display: flex;
  flex-direction: column;
  gap: 2rem;
`,rn=h.Ay.div`
...
`,on=h.Ay.label`
  ...
  font-size: ${({theme:e})=>e.fontSize.lg};
  font-weight: ${({theme:e})=>e.fontWeight.medium};
`,nn=({readonly:e=!1,id:t,title:i,subtitle:o,children:n})=>(0,r.jsxs)(tn,{children:[(0,r.jsxs)(rn,{children:[(0,r.jsx)(on,{htmlFor:t,children:i}),!e&&(0,r.jsx)(Br,{description:`💡 ${o}`})]}),n]}),sn=h.Ay.div`
  display: flex;
  flex-direction: column;
...
`,fn=()=>{const e=(0,u.Zp)(),{accessCode:t}=(0,u.g)();(0,o.useEffect)((()=>{const e=e=>{e.preventDefault()};return window.addEventListener("beforeunload",e),()=>{window.removeEventListener("beforeunload",e)}}),[]);const{isModalOpen:i,openModal:n,closeModal:s}=(0,Fe.A)(),{answers:a,handleChange:l,handleSubmit:c}=(e=>{const t=(0,u.Zp)(),[i,r]=(0,o.useState)(Array(dn.length).fill("")),{addRetrospectMutation:n}=fr();return{answers:i,handleChange:(e,t)=>{if(t.length>1e3)return;const o=[...i];o[e]=t,r(o)},handleSubmit:async r=>{r.preventDefault(),n({accessCode:e,answers:i},{onSuccess:()=>t(`/room/${e}/completed`,{state:{valid:!0},replace:!0})})}}})(t||""),d=a.every((e=>!e.trim()));return(0,r.jsx)(mn,{children:(0,r.jsxs)(hn,{children:[(0,r.jsx)(en,{title:"회고 작성하기",subTitle:"지금까지 진행한 페어 프로그래밍에 대한 회고를 작성해 보세요!",buttonText:"나중에 작성하기",onButtonClick:n}),(0,r.jsxs)(un,{onSubmit:c,children:[dn.map(((e,t)=>(0,r.jsx)(nn,{id:e.id,title:e.title,subtitle:e.subtitle,children:(0,r.jsx)(cn,{id:e.id,value:a[t],onChange:e=>l(t,e.target.value),placeholder:"질문에 대한 답변을 작성해주세요.",charNumber:`${a[t].length} / 1000`},e.id)},e.id))),(0,r.jsx)(pn,{children:(0,r.jsx)($e.A,{width:"100%",height:"5rem",borderRadius:"0",type:"submit",disabled:d,children:"작성 완료"})})]}),(0,r.jsx)(qi.A,{title:"나중에 작성하시겠습니까?",subTitle:"작성된 내용이 모두 사라질 수 있어요.",isOpen:i,close:s,onConfirm:()=>e(`/room/${t}/completed`,{state:{valid:!0},replace:!0})})]})})},gn=h.Ay.div`
  display: flex;
  justify-content: center;
...
`,bn=()=>{const{accessCode:e}=(0,u.g)(),t=(0,u.Zp)(),{answers:i,isFetching:o}=(e=>{const{data:t,isFetching:i}=(0,De.I)({queryKey:[Ue.e.GET_RETROSPECT_ANSWER],queryFn:()=>(async e=>{const t=await g.A.get({url:`undefined/retrospects/${e}`,errorMessage:x.U.GET_RETROSPECT});return await t.json()})(e),retry:!1});return{answers:t?.answers||[],isFetching:i}})(e||"");return o?(0,r.jsx)(p.A,{size:"sm"}):(0,r.jsx)(gn,{children:(0,r.jsxs)(xn,{children:[(0,r.jsx)(en,{title:e||"",subTitle:`${e}에서 작성한 회고입니다!`,buttonText:"페어룸으로 이동",onButtonClick:()=>t(`/room/${e}/completed`,{state:{valid:!0},replace:!0})}),dn.map(((e,t)=>(0,r.jsx)(nn,{readonly:!0,id:e.id,title:e.title,subtitle:e.subtitle,children:(0,r.jsx)(yn,{children:i[t]})},e.id)))]})})},$n=h.Ay.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 6rem;
...
`,jn=h.Ay.h1`
  ...
  font-size: ${({theme:e})=>e.fontSize.h5};
  font-weight: ${({theme:e})=>e.fontWeight.medium};
`,An=()=>{const e=(0,u.Zp)(),{userStatus:t}=(0,f.A)();(0,o.useEffect)((()=>{"SIGNED_IN"===t&&e("/main",{replace:!0})}),[t]);const{value:i,status:n,message:s,handleChange:a}=(0,Fi.A)(),{handleSignUp:l}=(()=>{const e=(0,u.Zp)(),{setUser:t}=(0,f.A)();return{handleSignUp:async i=>{await(async e=>{const t=await g.A.post({url:"undefined/sign-up",body:JSON.stringify({username:e}),errorMessage:x.U.SIGN_UP});return await t.json()})(i),t(i,"SIGNED_IN"),e("/main")}}})();return(0,r.jsxs)($n,{children:[(0,r.jsx)(vn,{src:le.Xo,alt:"logo_icon_with_title"}),(0,r.jsxs)(wn,{onSubmit:e=>{e.preventDefault(),l(i)},children:[(0,r.jsx)(jn,{children:"첫 방문이시네요! 당신을 어떻게 불러야 할까요?"}),(0,r.jsxs)(Ni.F,{children:[(0,r.jsx)(Ni.F.Input,{value:i,status:n,width:"50rem",title:"이름(또는 닉네임)",placeholder:"이름(또는 닉네임)을 입력해주세요.",onChange:e=>{a(e,co(e.target.value))}}),(0,r.jsx)(Ni.F.Message,{status:n,children:s})]}),(0,r.jsx)($e.A,{width:"50rem",height:"10rem",fontSize:ve.w.fontSize.md,type:"submit",disabled:"ERROR"===co(i).status,children:"계정 만들기 🥳"})]})]})},Sn=h.DU`
    /*
...
`,En=(0,o.lazy)((()=>Promise.all([i.e(248),i.e(272)]).then(i.bind(i,8272)))),kn=new d.E({defaultOptions:{queries:{refetchOnWindowFocus:!1}}});var Rn=i(2691),zn=i.n(Rn),On=i(7825),Tn=i.n(On),Cn=i(7659),_n=i.n(Cn),In=i(5056),Nn=i.n(In),Mn=i(540),Fn=i.n(Mn),Pn=i(1113),Dn=i.n(Pn),Un=i(9497),Gn={};Gn.styleTagTransform=Dn(),Gn.setAttributes=Nn(),Gn.insert=_n().bind(null,"head"),Gn.domAPI=Tn(),Gn.insertStyleElement=Fn(),zn()(Un.A,Gn),Un.A&&Un.A.locals&&Un.A.locals,n.T({dsn:void 0,integrations:[s.dp(),a.w()],tracesSampleRate:1,tracePropagationTargets:["localhost:3001","https://coduo.site",/^\/api\//],replaysSessionSampleRate:.1,replaysOnErrorSampleRate:1}),l.createRoot(document.getElementById("root")).render((0,r.jsx)(o.StrictMode,{children:(0,r.jsx)((()=>{const{setUser:e}=(0,f.A)();(0,o.useEffect)((()=>{"/callback"!==window.location.pathname&&(async()=>{const{signedIn:t}=await(async()=>{const e=await g.A.get({url:"undefined/sign-in/check",errorMessage:x.U.CHECK_USER_LOGIN});return await e.json()})();if(!t)return void e("","SIGNED_OUT");const{username:i}=await y();e(i,"SIGNED_IN")})()}),[]);const t=(0,c.Ys)([{path:"/",element:(0,r.jsx)(Ai,{}),errorElement:(0,r.jsx)(St,{}),children:[{path:"",element:(0,r.jsx)(ti,{})},{path:"main",element:(0,r.jsx)(Bi,{})},{path:"how-to-pair",element:(0,r.jsx)(Xt,{})},{path:"onboarding",element:(0,r.jsx)(Yo,{})},{path:"room",element:(0,r.jsx)(Vo,{}),children:[{path:":accessCode",element:(0,r.jsx)(o.Suspense,{fallback:(0,r.jsx)(ce.A,{}),children:(0,r.jsx)(En,{})})},{path:":accessCode/completed",element:(0,r.jsx)(o.Suspense,{fallback:(0,r.jsx)(ce.A,{}),children:(0,r.jsx)($t,{})})},{path:":accessCode/retrospect",element:(0,r.jsx)(o.Suspense,{fallback:(0,r.jsx)(ce.A,{}),children:(0,r.jsx)(bn,{})})},{path:":accessCode/retrospectForm",element:(0,r.jsx)(o.Suspense,{fallback:(0,r.jsx)(ce.A,{}),children:(0,r.jsx)(fn,{})})}]},{path:"sign-up",element:(0,r.jsx)(An,{})},{path:"coduo-docs",element:(0,r.jsx)(ae,{})},{path:"callback",element:(0,r.jsx)(S,{})},{path:"my-page",element:(0,r.jsx)(Sr,{})},{path:"error",element:(0,r.jsx)(St,{})},{path:"*",element:(0,r.jsx)(St,{})}]}]);return(0,r.jsx)(m.Ht,{client:kn,children:(0,r.jsxs)(h.NP,{theme:ve.w,children:[(0,r.jsx)(Sn,{}),(0,r.jsx)(c.pg,{router:t})]})})}),{})}))},7418:(e,t,i)=>{i.d(t,{A:()=>l});var r=i(4848),o=i(131),n=i(7581);const s=n.Ay.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
